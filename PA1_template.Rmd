...
plot1 + geom_vline(aes(xintercept = mean(dailysteps$total)), colour = "red", size = 1) + geom_vline(aes(xintercept = median(dailysteps$total)), colour = "blue", size = 1, alpha = .5)
```
...
g + geom_line(size = 1, colour = "steelblue") + labs(x = "Time interval [5 mins]", y = "Average Steps", title = "Daily Average of Steps taken by Interval")
